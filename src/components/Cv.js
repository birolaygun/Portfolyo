    ...
    <section className="cv">
      ...
      <div className="aboutMeCv">
        ...
        <div className="lang">
          ...
          <h3>İngilizce</h3>
          <p>
            <b>İntermediate</b> seviyede İngilizcem var. İngilizce kaynaklardan
            faydalanacak kadar iyi seviyede.
          </p>
        </div>
        ...
        <div className="paragraph">
          ...
          <p>
            Yazılım dünyasında yeniliklere açık olmak ve çağa ayak uydurmak bir
            zorunluluktur. Bunun bilincinde ve sürekli öğrenmeye açık bir
